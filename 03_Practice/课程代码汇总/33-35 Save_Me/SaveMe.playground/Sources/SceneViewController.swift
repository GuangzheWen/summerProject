...
public class SceneViewController: UIViewController {
    ...
    public override func viewDidLoad() {
        ...
        // The red and blue background Image.
...
//        retryButton.addTarget(self, action: #selector(retry), for: .touchUpInside)
    ...
    @objc func changeToNextScene() {
        if currentScene == 1 {
            ...
            // Animation: make introduction label visible.
            UIView.animate(withDuration: 1.2,
                           animations: {
            ...
            // Animation: dismiss introduction label.
            UIView.animate(withDuration: 1.2,
                           animations: {
            ...
            // Animation: change introduction label's text and show again.
            UIView.animate(withDuration: 1.2,
                           animations: {
                            self.introduceLabel.transform = CGAffineTransform(translationX: 300, y: 0)
                            self.introduceLabel.alpha = 0.0
                           ...
                           completion: { _ in
                            ...
                            UIView.animate(withDuration: 0.5,
                                           ...
                                           completion: { _ in
                                            ...
                                            // Animation: scale introduction label.
                                            self.animationTimer = Timer.scheduledTimer(timeInterval: 1, target: self, selector: #selector(self.scaleIntroduceLabel), userInfo: nil, repeats: true)
            ...
            // Animation: change text and show again.
            UIView.animate(withDuration: 1.2,
                           ...
                           completion: { _ in
                            ...
                            UIView.animate(withDuration: 0.8, animations: {
                                ...
                                // Make the label stay for 2.5 seconds.
                                self.animationTimer = Timer.scheduledTimer(timeInterval: 2.5, target: self, selector: #selector(self.introduceLabelStay), userInfo: nil, repeats: true)
                                self.animationTimer.fire()
                            })
    ...
    func timesUp() {
        ...
        UIView.animate(withDuration: 1, animations: {
            ...
            // gameTitleLabel shows the title of the game.
    ...
    func setupGameView() {
        // create question according to game difficulty.
        if gameDifficulty == 1 {
